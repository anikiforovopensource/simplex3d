...
) extends CompositeSeq[Vec2d, R](backing) {
...
) extends BaseVec2d[R](backingSeq) with DataArray[Vec2d, R] {
...
) extends BaseVec2d[R](backingSeq) with DataBuffer[Vec2d, R] {
...
) extends BaseVec2d[R](backingSeq) with DataView[Vec2d, R] {
