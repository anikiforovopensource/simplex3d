...
object Descriptors {
  ...
  implicit val Int1SInt = Descriptor[Int1, SInt](Manifest.Int, Manifest.Int, 1, RawData.SInt, false)
  implicit val Int1UInt = Descriptor[Int1, UInt](Manifest.Int, Manifest.Int, 1, RawData.UInt, false)
  ...
  implicit val Vec2iSInt = Descriptor[Vec2i, SInt](Vec2i.Manifest, Manifest.Int, 2, RawData.SInt, false)
  implicit val Vec2iUInt = Descriptor[Vec2i, UInt](Vec2i.Manifest, Manifest.Int, 2, RawData.UInt, false)
  ...
  implicit val Vec3iSInt = Descriptor[Vec3i, SInt](Vec3i.Manifest, Manifest.Int, 3, RawData.SInt, false)
  implicit val Vec3iUInt = Descriptor[Vec3i, UInt](Vec3i.Manifest, Manifest.Int, 3, RawData.UInt, false)
  ...
  implicit val Vec4iSInt = Descriptor[Vec4i, SInt](Vec4i.Manifest, Manifest.Int, 4, RawData.SInt, false)
  implicit val Vec4iUInt = Descriptor[Vec4i, UInt](Vec4i.Manifest, Manifest.Int, 4, RawData.UInt, false)
  ...
  implicit val Float1SInt = Descriptor[Float1, SInt](Manifest.Float, Manifest.Float, 1, RawData.SInt, true)
  implicit val Float1UInt = Descriptor[Float1, UInt](Manifest.Float, Manifest.Float, 1, RawData.UInt, true)
  ...
  implicit val Vec2fSInt = Descriptor[Vec2f, SInt](Vec2f.Manifest, Manifest.Float, 2, RawData.SInt, true)
  implicit val Vec2fUInt = Descriptor[Vec2f, UInt](Vec2f.Manifest, Manifest.Float, 2, RawData.UInt, true)
  ...
  implicit val Vec3fSInt = Descriptor[Vec3f, SInt](Vec3f.Manifest, Manifest.Float, 3, RawData.SInt, true)
  implicit val Vec3fUInt = Descriptor[Vec3f, UInt](Vec3f.Manifest, Manifest.Float, 3, RawData.UInt, true)
  ...
  implicit val Vec4fSInt = Descriptor[Vec4f, SInt](Vec4f.Manifest, Manifest.Float, 4, RawData.SInt, true)
  implicit val Vec4fUInt = Descriptor[Vec4f, UInt](Vec4f.Manifest, Manifest.Float, 4, RawData.UInt, true)
  ...
  implicit val Double1SInt = Descriptor[Double1, SInt](Manifest.Double, Manifest.Double, 1, RawData.SInt, true)
  implicit val Double1UInt = Descriptor[Double1, UInt](Manifest.Double, Manifest.Double, 1, RawData.UInt, true)
  ...
  implicit val Vec2dSInt = Descriptor[Vec2d, SInt](Vec2d.Manifest, Manifest.Double, 2, RawData.SInt, true)
  implicit val Vec2dUInt = Descriptor[Vec2d, UInt](Vec2d.Manifest, Manifest.Double, 2, RawData.UInt, true)
  ...
  implicit val Vec3dSInt = Descriptor[Vec3d, SInt](Vec3d.Manifest, Manifest.Double, 3, RawData.SInt, true)
  implicit val Vec3dUInt = Descriptor[Vec3d, UInt](Vec3d.Manifest, Manifest.Double, 3, RawData.UInt, true)
  ...
  implicit val Vec4dSInt = Descriptor[Vec4d, SInt](Vec4d.Manifest, Manifest.Double, 4, RawData.SInt, true)
  implicit val Vec4dUInt = Descriptor[Vec4d, UInt](Vec4d.Manifest, Manifest.Double, 4, RawData.UInt, true)
