...
private[backend] final class AttributeBinding(val name: String, val dataType: Int, val location: Int) {
...
private[backend] class UniformBinding(
...
private[backend] final class UniformTexBinding(
