...
//  private val vectorState = new Array[VectorBinding](programMapping.uniformVectors.length)
  
//  private def uniform(location: Int, r: ReadDoubleRef) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadDoubleRef].equals(r)) {
//      glUniform1f(location, r.toConst.toFloat); vectorState(location) = r
//    }
//  }
//  private def uniform(location: Int, u: inVec2) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadVec2].equals(u)) {
//      glUniform2f(location, u.x.toFloat, u.y.toFloat); vectorState(location) = u
//    }
//  }
//  private def uniform(location: Int, u: inVec3) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadVec3].equals(u)) {
//      glUniform3f(location, u.x.toFloat, u.y.toFloat, u.z.toFloat); vectorState(location) = u
//    }
//  }
//  private def uniform(location: Int, u: inVec4) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadVec4].equals(u)) {
//      glUniform4f(location, u.x.toFloat, u.y.toFloat, u.z.toFloat, u.w.toFloat); vectorState(location) = u
//    }
//  }
//  private def uniform(location: Int, q: inQuat4) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadQuat4].equals(q)) {
//      glUniform4f(location, q.b.toFloat, q.c.toFloat, q.d.toFloat, q.a.toFloat); vectorState(location) = q
//    }
//  }
//  
//  private def uniform(location: Int, r: ReadIntRef) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadIntRef].equals(r)) {
//      glUniform1i(location, r.toConst); vectorState(location) = r
//    }
//  }
//  private def uniform(location: Int, u: inVec2i) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadVec2i].equals(u)) {
//      glUniform2i(location, u.x, u.y); vectorState(location) = u
//    }
//  }
//  private def uniform(location: Int, u: inVec3i) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadVec3i].equals(u)) {
//      glUniform3i(location, u.x, u.y, u.z); vectorState(location) = u
//    }
//  }
//  private def uniform(location: Int, u: inVec4i) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadVec4i].equals(u)) {
//      glUniform4i(location, u.x, u.y, u.z, u.w); vectorState(location) = u
//    }
//  }
//  
//  private def uniform(location: Int, r: ReadBooleanRef) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadBooleanRef].equals(r)) {
//      glUniform1i(location, toInt(r.toConst)); vectorState(location) = r
//    }
//  }
//  private def uniform(location: Int, u: inVec2b) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadVec2b].equals(u)) {
//      glUniform2i(location, toInt(u.x), toInt(u.y)); vectorState(location) = u
//    }
//  }
//  private def uniform(location: Int, u: inVec3b) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadVec3b].equals(u)) {
//      glUniform3i(location, toInt(u.x), toInt(u.y), toInt(u.z)); vectorState(location) = u
//    }
//  }
//  private def uniform(location: Int, u: inVec4b) {
//    val s = vectorState(location)
//    if (s == null || !s.asInstanceOf[ReadVec4b].equals(u)) {
//      glUniform4i(location, toInt(u.x), toInt(u.y), toInt(u.z), toInt(u.w)); vectorState(location) = u
//    }
//  }
