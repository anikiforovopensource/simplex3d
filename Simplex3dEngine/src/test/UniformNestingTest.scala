...
object UniformNestingTest extends default.BasicFullscreenEffectApp {
  ...
  final class Struct2 extends ReadStruct2 with ReflectStruct[Struct2] {
    ...
    def :=(r: Readable[Struct2]) {
      val s = r.asInstanceOf[ReadStruct2]
      value2 := s.value2
      value2Array := s.value2Array
      texture2 := s.texture2
    }
  }
  ...
  final class Struct1 extends ReadStruct1 with ReflectStruct[Struct1] {
    ...
    def :=(r: Readable[Struct1]) {
      val s = r.asInstanceOf[ReadStruct1]
      value1 := s.value1
      value1Array := s.value1Array
      texture1 := s.texture1
      texture1Array := s.texture1Array
      struct2 := s.struct2
      struct2Array := s.struct2Array
    }
  }
