...
with ReadPropertyValue[Vec3b] with Serializable
{
...
with PropertyValue[Vec3b] with Serializable
{
  px = cx; py = cy; pz = cz
  ...
  def :=(r: Readable[Vec3b]) { val u = r.asInstanceOf[ReadVec3b]; x = u.x; y = u.y; z = u.z }
