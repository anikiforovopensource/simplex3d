...
with ReadPropertyValue[Quat4d] with Serializable
{
...
with PropertyValue[Quat4d] with Serializable
{
  pa = ca; pb = cb; pc = cc; pd = cd
  ...
  def :=(r: Readable[Quat4d]) { val q = r.asInstanceOf[ReadQuat4d]; a = q.a; b = q.b; c = q.c; d = q.d }
