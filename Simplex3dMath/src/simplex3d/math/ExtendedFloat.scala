 ...
 */
final class ExtendedFloat(val value: Float) extends ReadAny[Float] {
     ...
     * Read: "this isApproximately x".
     */
    def ~=(x: Float) :Boolean = {
        abs(value - x) < ApproximationDelta
    }

    /**
     * Inverse of approximate comparision.
     * Read: "this isNotApproximately x" or "this isDistinctFrom x".
     */
