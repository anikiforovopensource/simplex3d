...
with ReadPropertyRef[ReadVec3b] with Serializable
{
...
extends ReadVec3b with Immutable with Cloneable[ConstVec3b] with Serializable {
  px = cx; py = cy; pz = cz
...
with PropertyRef[ReadVec3b] with Cloneable[Vec3b] with Serializable
{
  px = cx; py = cy; pz = cz
