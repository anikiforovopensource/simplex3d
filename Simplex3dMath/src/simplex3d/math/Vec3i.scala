...
sealed abstract class ReadVec3i
extends ProtectedVec3i[Int] with ReadPropertyRef[ReadVec3i]
{
...
extends ReadVec3i with CompositeMeta with Implicits[On] with PropertyRef[ReadVec3i]
{
  px = cx; py = cy; pz = cz
