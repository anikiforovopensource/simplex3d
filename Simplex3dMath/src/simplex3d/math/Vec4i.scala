...
sealed abstract class ReadVec4i
extends ProtectedVec4i[Int] with ReadPropertyRef[ReadVec4i]
{
...
extends ReadVec4i with CompositeMeta with Implicits[On] with PropertyRef[ReadVec4i]
{
  px = cx; py = cy; pz = cz; pw = cw
