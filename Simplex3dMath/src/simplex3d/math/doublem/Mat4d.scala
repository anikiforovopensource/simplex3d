...
sealed abstract class AnyMat4d extends Read4x4[ConstVec4d]
{
  ...
  private[math] override def f33 = float(m33)
  ...
  private[math] def transposeMul(u: inVec4d) = new Vec4d(
