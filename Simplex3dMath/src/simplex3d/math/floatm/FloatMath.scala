...
object FloatMath {
  ...
  val Pi: Float = float(SMath.PI)
  val E: Float = float(SMath.E)
  ...
  // Transform
  def transformation(scale: inVec2f,
             rotation: inMat2f,
             translation: inVec2f)
  :Mat2x3f =
  {
   ...
   */
  def inverseTransformation(scale: inVec2f,
                rotation: inMat2f,
                translation: inVec2f)
  :Mat2x3f =
  {
  ...
  def transformation(scale: inVec3f,
             rotation: inMat3f,
             translation: inVec3f)
  :Mat3x4f =
  {
   ...
   * an unscaled rotation) to achieve the desired result.
   */
  def inverseTransformation(scale: inVec3f,
                rotation: inMat3f,
                translation: inVec3f)
  :Mat3x4f =
  {
