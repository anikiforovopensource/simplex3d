...
extends ProtectedMat2x3f[Float, ReadMat2x3f]
{
  // Column major order.
...
final class ConstMat2x3f private[math] (
  ...
  c01: Float, c11: Float,
  c02: Float, c12: Float
) extends ReadMat2x3f with Immutable
{
  p00 = c00; p10 = c10
  p01 = c01; p11 = c11
  p02 = c02; p12 = c12
...
object ConstMat2x3f {
  ...
  def apply(m: AnyMat[_, _]) = new ConstMat2x3f(
    m.f00, m.f10,
    m.f01, m.f11,
    m.f02, m.f12
  )
...
final class Mat2x3f private[math] (
  ...
  with MutableObject[ReadMat2x3f] with Implicits[On] with Composite
{
  p00 = c00; p10 = c10
  p01 = c01; p11 = c11
  p02 = c02; p12 = c12
...
object Mat2x3f {
  ...
  final val Manifest = classType[ReadMat2x3f](classOf[ReadMat2x3f])
  ...
  def apply(m: AnyMat[_, _]) = new Mat2x3f(
    m.f00, m.f10,
    m.f01, m.f11,
    m.f02, m.f12
  )
