 ...
 */
sealed abstract class AnyMat3f extends Read3x3
{
    // Column major order.
    ...
    def *(u: AnyVec3f) = new Vec3f(
        m00*u.x + m01*u.y + m02*u.z,
        m10*u.x + m11*u.y + m12*u.z,
        m20*u.x + m21*u.y + m22*u.z
    )
    private[math] def transposeMul(u: AnyVec3f) = new Vec3f(
...
object ConstMat3f {
    ...
    def apply(m: Read3x3) = new ConstMat3f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        m.f02, m.f12, m.f22
    )
...
object Mat3f {
    ...
    def apply(m: Read2x2) = new Mat3f(
        m.f00, m.f10, 0,
        m.f01, m.f11, 0,
        0, 0, 1
    )

    def apply(m: Read2x3) = new Mat3f(
        m.f00, m.f10, 0,
        m.f01, m.f11, 0,
        m.f02, m.f12, 1
    )

    def apply(m: Read2x4) = new Mat3f(
        m.f00, m.f10, 0,
        m.f01, m.f11, 0,
        m.f02, m.f12, 1
    )

    def apply(m: Read3x2) = new Mat3f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        0, 0, 1
    )

    def apply(m: Read3x3) = new Mat3f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        m.f02, m.f12, m.f22
    )

    def apply(m: Read3x4) = new Mat3f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        m.f02, m.f12, m.f22
    )

    def apply(m: Read4x2) = new Mat3f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        0, 0, 1
    )

    def apply(m: Read4x3) = new Mat3f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        m.f02, m.f12, m.f22
    )

    def apply(m: Read4x4) = new Mat3f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        m.f02, m.f12, m.f22
    )
