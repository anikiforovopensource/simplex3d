 ...
 */
sealed abstract class AnyMat3x2f extends Read3x2
{
    // Column major order.
...
object ConstMat3x2f {
    ...
    def apply(m: Read3x2) = new ConstMat3x2f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21
    )

    implicit def toConst(m: Mat3x2f) = ConstMat3x2f(m)
}
...
object Mat3x2f {
    ...
    def apply(m: Read2x2) = new Mat3x2f(
        m.f00, m.f10, 0,
        m.f01, m.f11, 0
    )

    def apply(m: Read2x3) = new Mat3x2f(
        m.f00, m.f10, 0,
        m.f01, m.f11, 0
    )

    def apply(m: Read2x4) = new Mat3x2f(
        m.f00, m.f10, 0,
        m.f01, m.f11, 0
    )

    def apply(m: Read3x2) = new Mat3x2f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21
    )

    def apply(m: Read3x3) = new Mat3x2f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21
    )

    def apply(m: Read3x4) = new Mat3x2f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21
    )

    def apply(m: Read4x2) = new Mat3x2f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21
    )

    def apply(m: Read4x3) = new Mat3x2f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21
    )

    def apply(m: Read4x4) = new Mat3x2f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21
    )
    ...
    implicit def toMutable(m: ConstMat3x2f) = Mat3x2f(m)
}
