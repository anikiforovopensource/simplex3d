...
extends ProtectedMat3x4f[Float, AnyMat3x4f]
{
  // Column major order.
...
object ConstMat3x4f {
  ...
  def apply(m: ReadMat[_, _]) = new ConstMat3x4f(
    m.f00, m.f10, m.f20,
    m.f01, m.f11, m.f21,
    m.f02, m.f12, m.f22,
    m.f03, m.f13, m.f23
...
final class Mat3x4f private[math] (
  ...
  with MutableObject[AnyMat3x4f] with Implicits[On] with Composite
{
  p00 = c00; p10 = c10; p20 = c20
  p01 = c01; p11 = c11; p21 = c21
  p02 = c02; p12 = c12; p22 = c22
...
object Mat3x4f {
  ...
  final val Manifest = classType[AnyMat3x4f](classOf[AnyMat3x4f])
  ...
  def apply(m: ReadMat[_, _]) = new Mat3x4f(
    m.f00, m.f10, m.f20,
    m.f01, m.f11, m.f21,
    m.f02, m.f12, m.f22,
    m.f03, m.f13, m.f23
