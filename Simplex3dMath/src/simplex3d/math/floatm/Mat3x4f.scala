 ...
 */
sealed abstract class AnyMat3x4f extends Read3x4
{
    // Column major order.
    ...
    private[math] def transposeMul(u: AnyVec3f) = new Vec4f(
    ...
    def scale(s: Float) :Mat3x4f = this*s
    def scale(s: AnyVec3f) :Mat3x4f = new Mat3x4f(
    ...
    def translate(u: AnyVec3f) :Mat3x4f = new Mat3x4f(
        m00, m10, m20,
        m01, m11, m21,
        m02, m12, m22,
        m03 + u.x, m13 + u.y, m23 + u.z
    ...
    def concatenate(m: AnyMat3x4f) :Mat3x4f = new Mat3x4f(
    ...
    def concatenate(m: AnyMat3f) :Mat3x4f = m*this

    def transformPoint(p: AnyVec3f) :Vec3f = new Vec3f(
        m00*p.x + m01*p.y + m02*p.z + m03,
        m10*p.x + m11*p.y + m12*p.z + m13,
        m20*p.x + m21*p.y + m22*p.z + m23
    )
    def transformVector(v: AnyVec3f) :Vec3f = new Vec3f(
        m00*v.x + m01*v.y + m02*v.z,
        m10*v.x + m11*v.y + m12*v.z,
        m20*v.x + m21*v.y + m22*v.z
    )

    def invert() :Mat3x4f = inverse(this)
...
object ConstMat3x4f {
    ...
    def apply(m: Read3x4) = new ConstMat3x4f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        m.f02, m.f12, m.f22,
        m.f03, m.f13, m.f23
    ...
    implicit def toConst(m: Mat3x4f) = ConstMat3x4f(m)
}
...
object Mat3x4f {
    ...
    def apply(m: Read2x2) = new Mat3x4f(
        m.f00, m.f10, 0,
        m.f01, m.f11, 0,
        0, 0, 1,
        0, 0, 0
    ...
    def apply(m: Read2x3) = new Mat3x4f(
        m.f00, m.f10, 0,
        m.f01, m.f11, 0,
        m.f02, m.f12, 1,
        0, 0, 0
    ...
    def apply(m: Read2x4) = new Mat3x4f(
        m.f00, m.f10, 0,
        m.f01, m.f11, 0,
        m.f02, m.f12, 1,
        m.f03, m.f13, 0
    ...
    def apply(m: Read3x2) = new Mat3x4f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        0, 0, 1,
        0, 0, 0
    ...
    def apply(m: Read3x3) = new Mat3x4f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        m.f02, m.f12, m.f22,
        0, 0, 0
    ...
    def apply(m: Read3x4) = new Mat3x4f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        m.f02, m.f12, m.f22,
        m.f03, m.f13, m.f23
    ...
    def apply(m: Read4x2) = new Mat3x4f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        0, 0, 1,
        0, 0, 0
    ...
    def apply(m: Read4x3) = new Mat3x4f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        m.f02, m.f12, m.f22,
        0, 0, 0
    ...
    def apply(m: Read4x4) = new Mat3x4f(
        m.f00, m.f10, m.f20,
        m.f01, m.f11, m.f21,
        m.f02, m.f12, m.f22,
        m.f03, m.f13, m.f23
