...
final class ConstMat4x3f private (
...
object ConstMat4x3f {
    ...
    def apply(args: ReadAny[Float]*) :ConstMat4x3f = {
    ...
    def apply(m: AnyMat2f) = new ConstMat4x3f(
        m.m00, m.m10, 0, 0,
        m.m01, m.m11, 0, 0,
        0, 0, 1, 0
    )

    def apply(m: AnyMat2x3f) = new ConstMat4x3f(
        m.m00, m.m10, 0, 0,
        m.m01, m.m11, 0, 0,
        m.m02, m.m12, 1, 0
    )

    def apply(m: AnyMat2x4f) = new ConstMat4x3f(
        m.m00, m.m10, 0, 0,
        m.m01, m.m11, 0, 0,
        m.m02, m.m12, 1, 0
    )

    def apply(m: AnyMat3x2f) = new ConstMat4x3f(
        m.m00, m.m10, m.m20, 0,
        m.m01, m.m11, m.m21, 0,
        0, 0, 1, 0
    )

    def apply(m: AnyMat3f) = new ConstMat4x3f(
        m.m00, m.m10, m.m20, 0,
        m.m01, m.m11, m.m21, 0,
        m.m02, m.m12, m.m22, 0
    )

    def apply(m: AnyMat3x4f) = new ConstMat4x3f(
        m.m00, m.m10, m.m20, 0,
        m.m01, m.m11, m.m21, 0,
        m.m02, m.m12, m.m22, 0
    )

    def apply(m: AnyMat4x2f) = new ConstMat4x3f(
        m.m00, m.m10, m.m20, m.m30,
        m.m01, m.m11, m.m21, m.m31,
        0, 0, 1, 0
    )

    def apply(m: AnyMat4x3f) = new ConstMat4x3f(
        m.m00, m.m10, m.m20, m.m30,
        m.m01, m.m11, m.m21, m.m31,
        m.m02, m.m12, m.m22, m.m32
    )

    def apply(m: AnyMat4f) = new ConstMat4x3f(
        m.m00, m.m10, m.m20, m.m30,
        m.m01, m.m11, m.m21, m.m31,
        m.m02, m.m12, m.m22, m.m32
    )

    implicit def mutableToConst(m: Mat4x3f) = ConstMat4x3f(m)
}


final class Mat4x3f private (
...
object Mat4x3f {
    ...
    def apply(args: ReadAny[Float]*) :Mat4x3f = {
        val mat = new Array[Float](12)
        mat(0) = 1
        mat(5) = 1
        mat(10) = 1
