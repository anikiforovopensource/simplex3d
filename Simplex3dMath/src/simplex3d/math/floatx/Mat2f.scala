...
with ReadPropertyRef[Mat2f] with Cloneable[ReadMat2f] with Serializable
{
...
with PropertyRef[Mat2f] with Cloneable[Mat2f] with Serializable
{
  p00 = c00; p10 = c10
  p01 = c01; p11 = c11
  ...
  def :=(u: ConstMat2f) { this := u.asInstanceOf[inMat2f] }
