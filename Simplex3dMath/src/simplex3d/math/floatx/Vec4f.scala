...
sealed abstract class ReadVec4f
extends ProtectedVec4f[Float] with ReadPropertyRef[ReadVec4f]
{
...
extends ReadVec4f with CompositeMeta with Implicits[On] with PropertyRef[ReadVec4f]
{
  px = cx; py = cy; pz = cz; pw = cw
